...
public final class BlockModel {
    ...
    public static final class ElementBuilder {
        ...
        ElementBuilder(final BlockModel parent, final Vector3d from, final Vector3d to, final boolean shade) {
            this.parent = parent;
            this.from = from;
            this.to = to;
            this.shade = shade;
    ...
    private BlockModel(final ResourceLocation parent) {
        this.parent = parent;
    ...
    public static BlockModel of(final ResourceLocation parent) {
        return new BlockModel(parent);
    }

    public static BlockModel ofGenerated() {
        return new BlockModel(new ResourceLocation("builtin/generated"));
    }

    public BlockModel ambientOcclusion(final boolean ambientOcclusion) {
    ...
    public BlockModel display(final DisplayPosition position, final Vector3d rotation, final Vector3d translation, final Vector3d scale) {
        Objects.requireNonNull(position);
    ...
    public BlockModel texture(final String name, final ResourceLocation path) {
    ...
    public BlockModel particle(final ResourceLocation path) {
        return this.texture("particle", path);
    }

    public BlockModel layer(final int id, final ResourceLocation path) {
        if (id < 0) {
    ...
    private BlockModel element(final Element element) {
