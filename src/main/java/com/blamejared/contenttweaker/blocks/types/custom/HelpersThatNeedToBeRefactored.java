...
final class HelpersThatNeedToBeRefactored {
    
    public static MapData getAllValues(final Collection<MCBlockStateProperty> blockStatePropertyList, BlockStateToModelMapping blockStateToModelMapping, MCResourceLocation location) {
